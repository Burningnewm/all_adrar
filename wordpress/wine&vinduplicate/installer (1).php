...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210914_winevin_b5a9e11d4ad953bf2296_20210914123447_archive.zip';
	const ARCHIVE_SIZE		 = '65839985';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b5a9e11-14123447';
    const SECONDARY_PACKAGE_HASH = '6a05173-14123447';
	const VERSION			 = '1.4.3';
